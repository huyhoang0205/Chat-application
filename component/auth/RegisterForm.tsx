...
export default function RegisterForm() {
    ...
    const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
        ...
        if(password !== confirmPassword) {
            setValidationError('Mật khẩu xác nhận phải giống với mật khẩu')
            return;
        }
    ...
    return (
        ...
        >
            ...
            <Box sx={{mt:2, textAlign: 'center'}}>
                ...
                >
                    Bạn đã có tài khoản?{''}
                    <Link href={'/login'} style={{color:'#00b0f4',textDecoration:'none',fontWeight:600}}>
                        Đăng nhập
                    </Link>
                </Typography>
            </Box>
